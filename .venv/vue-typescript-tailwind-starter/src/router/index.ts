...
// scrollBehavior: функция, которая управляет поведением прокрутки при навигации. 
// В данном случае мы указываем, что при переходе на новый маршрут страница всегда будет прокручиваться к верху.
